...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 16 13:06:17 2018
...
#*********Tidal coefficients****************#
Amp_M2=np.zeros(land.shape)
Phase_M2=np.zeros(land.shape) # I should think about using dictionnaries
# For flexibility
